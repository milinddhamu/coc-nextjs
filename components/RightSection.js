  ...
  return (
    <>
      ...
      <main className='flex flex-col gap-6 pb-6 px-6 md:px-3 border-b-[.5px] border-gray-500/20 sm:border-none'>
        <Card css={{ border: "none",borderRadius:"20px",margin:"0px",padding:"0px" }} className="threeDShadowLight relative overflow-hidden flex max-w-5xl" >
      ...
      <div>
        ...
        <Card css={{
          border: "none",
          borderRadius:"20px"
        }} className="threeDShadowLight flex flex-col items-center w-full overflow-scroll cursor-pointer scrollbar-none" >
          <Image
            src={Calendar}
            alt="Calendar"
          />
